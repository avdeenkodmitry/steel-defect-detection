...
if __name__ == "__main__":
    data_folder = "/home/davdeenko/diploma/steel_data"
    df_path = "/home/davdeenko/diploma/steel_data/train.csv"
    test_df = pd.read_csv('./steel_data/sample_submission.csv')
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)
    test_dataset = TestDataset('./steel_data/test_images', test_df, mean, std)
